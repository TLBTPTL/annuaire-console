...
void ecrire_csv_to_txt(const char* file_destination, client* enreg) {
  ...
  for (i;i<total_lignes(annuaire);i++){
...
void filtrer_un_champ(const char *annuaire,const char *nom_champ,const char *val_chaine){
...
void modifier_autres_que_mel_client(const char *annuaire,const char*,const char* nom_champ,const char* nv_valeur) {
...
int main(){
	...
	do{
        ...
        case 2:
            ...
            break;
        case 3:
            filtrer_un_champ(annuaire,"profe","ouvrier");
            break;
        case 4:
